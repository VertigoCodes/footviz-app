...
export default function ComparePage() {
  ...
  useEffect(() => {
    ...
    if (leftParam) setLeftId(leftParam)
    if (rightParam) setRightId(rightParam)
  }, [searchParams])
  ...
  const radarStats = [
    {
      label: 'Physical',
      leftValue: left.derived.physical,
      rightValue: right.derived.physical,
    },
    {
      label: 'Attack',
      leftValue: left.derived.attack,
      rightValue: right.derived.attack,
    },
    {
      label: 'Defense',
      leftValue: left.derived.defense,
      rightValue: right.derived.defense,
    },
    {
      label: 'Playmaking',
      leftValue: left.derived.playmaking,
      rightValue: right.derived.playmaking,
    },
    {
      label: 'Mobility',
      leftValue: left.derived.mobility,
      rightValue: right.derived.mobility,
    },
  ]
